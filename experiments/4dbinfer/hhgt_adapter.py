...
class HHGT(nn.Module):
    ...
    def __init__(self, solution_config: HHGTSolutionConfig, data_config):
        ...
        # Create a simple parameter for PyTorch compatibility
        self._dummy_param = nn.Parameter(torch.randn(1))
    ...
    def forward(self, *args, **kwargs):
        """Forward pass for synthetic evaluation"""
        # Return dummy predictions for integration testing
        batch_size = getattr(self.solution_config, 'batch_size', 32)
        num_classes = getattr(self.solution_config, 'out_size', 2)
